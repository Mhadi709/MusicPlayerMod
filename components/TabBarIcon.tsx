...
type TabBarIconProps = {
  name: React.ComponentProps<typeof Feather>['name']; // Nama ikon dari Feather
  color: string; // Warna ikon, akan diberikan oleh Tabs navigator
  size?: number; // Ukuran ikon, kita buat opsional
};
